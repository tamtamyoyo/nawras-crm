-- Fix security warnings by handling existing policies properly
-- This migration addresses all security issues shown in Supabase dashboard
...
UPDATE public.users SET created_by = auth.uid() WHERE created_by IS NULL;
